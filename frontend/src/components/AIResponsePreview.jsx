...
import { prism } from "react-syntax-highlighter/dist/esm/styles/prism"; // Colorful light theme
            ...
            code({ node, className, children, ...props }) {
              ...
              return !isInLine ? (
                <CodeBlock
                  ...
                  language={detectedLanguage} // Fixed typo: was 'langauge'
                />
              ) : (
                <code
...
function CodeBlock({ code, language }) {
  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-white border border-gray-200 shadow-sm">
      ...
      <SyntaxHighlighter
        language={language || "text"} // Provide fallback
        style={prism} // Colorful light theme
        customStyle={{
          fontSize: 12.5,
          margin: 0,
          padding: "1rem",
