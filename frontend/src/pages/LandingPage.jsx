      ...
      <div className="w-full min-h-full bg-[#bbd6ff]">
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <header className="flex justify-between items-center mb-16">
            <div className="text-xl text-black font-bold">prepDew</div>
            {user ? (
              <ProfileInfoCard />
            ) : (
              <button
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                {APP_FEATURES.slice(0, 3).map((feature) => (
                  <div
                    key={feature.id}
                    className="bg-blue-150 p-6 rounded-xl shadow-xs hover:shadow-2xl shadow-blue-200 transition border border-blue-400"
                  >
